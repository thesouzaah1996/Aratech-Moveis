...
@Table(
    name = "funcionarios",
    indexes = {
        @Index(name = "idx_funcionarios_cpf",   columnList = "cpf",   unique = true),
        @Index(name = "idx_funcionarios_email", columnList = "email", unique = true),
...
public class Funcionario {
    ...
    @NotBlank(message = "O tipo de funcionário é obrigatório")
    @Column(nullable = false)
